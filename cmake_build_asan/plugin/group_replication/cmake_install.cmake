# Install script for directory: /home/wuy/ShannonBase/plugin/group_replication
...
if(NOT CMAKE_INSTALL_LOCAL_ONLY)
  ...
  include("/home/wuy/ShannonBase/cmake_build_asan/plugin/group_replication/libmysqlgcs/cmake_install.cmake")
endif()

if(NOT CMAKE_INSTALL_LOCAL_ONLY)
  # Include the install script for the subdirectory.
  include("/home/wuy/ShannonBase/cmake_build_asan/plugin/group_replication/protobuf/cmake_install.cmake")
endif()
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Server" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/plugin" TYPE MODULE FILES "/home/wuy/ShannonBase/cmake_build_asan/plugin_output_directory/group_replication.so")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/plugin/group_replication.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/plugin/group_replication.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/plugin/group_replication.so"
...
if(CMAKE_INSTALL_LOCAL_ONLY)
  file(WRITE "/home/wuy/ShannonBase/cmake_build_asan/plugin/group_replication/install_local_manifest.txt"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
endif()
